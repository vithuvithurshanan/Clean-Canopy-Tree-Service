...
const reviews = [
  {
    img: '/work-1.webp',
    name: 'Sarah T.',
    text: 'They removed a massive oak that was leaning over our roof. Professional, fast, and the yard was spotless after.',
  },
  {
    img: '/work-2.webp',
    name: 'James R.',
    text: "Best tree service I've ever used. Fair price, showed up on time, and cleaned up perfectly.",
  },
  {
    img: '/work-3.webp',
    name: 'Linda M.',
    text: 'Trimmed all our trees and ground out three stumps in one afternoon. Amazing work!',
  },
]
        ...
        <div className="reviews-grid">
          {reviews.map((r) => (
            <div key={r.name} className="review-card">
              <img src={r.img} alt={`Job completed for ${r.name}`} className="review-img" />
